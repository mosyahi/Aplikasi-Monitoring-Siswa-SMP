						...
						<tr class="intro-x">
							...
							<td class="w-30">
								<div class="flex justify-center items-center">
									...
									<?php else : ?>
										<i data-lucide="x-square" class="w-4 h-4 mr-2 text-danger"></i>No
									<?php endif; ?>
								</div>
							...
							<td class="table-report__action w-56">
								<div class="flex justify-center items-center">
									<button class="flex items-center mr-3 text-primary" data-tw-toggle="modal" data-tw-target="#update-<?= $item['id_pelanggaran'] ?>"> <i data-lucide="edit" class="w-4 h-4 mr-1"></i> Edit </button>
								</div>
							</td>
						</tr>
					<?php endforeach ?>
...
<div id="header-footer-modal-preview" class="modal" tabindex="-1" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<form action="<?= base_url('guru/data-pelanggaran/add') ?>" method="POST" enctype="multipart/form-data">
	...
	<div id="update-<?= $item['id_pelanggaran'] ?>" class="modal" tabindex="-1" aria-hidden="true">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<form action="<?= base_url('guru/data-pelanggaran/update/' . $item['id_pelanggaran']) ?>" method="POST" enctype="multipart/form-data">
					<div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
