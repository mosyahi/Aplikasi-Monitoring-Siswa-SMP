                        ...
                        <tr class="intro-x">
                            ...
                            <td class="table-report__action w-56">
                                <div class="flex justify-center items-center">
                                    ...
                                    <button class="flex items-center text-danger" href="javascript:;" data-tw-toggle="modal" data-tw-target="#delete-<?= $item['id_kelas'] ?>" data-delete-url="<?= base_url('guru/data-kelas/delete/' . $item['id_kelas']) ?>"> <i data-lucide="trash-2" class="w-4 h-4 mr-1"></i> Delete </button>
                                </div>
                            </td>
                        </tr>
                    <?php endforeach ?>
...
<div id="header-footer-modal-preview" class="modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= base_url('guru/data-kelas/add') ?>" method="POST">
    ...
    <div id="update-<?= $item['id_kelas'] ?>" class="modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="<?= base_url('guru/data-kelas/update/' . $item['id_kelas']) ?>" method="POST">
                    <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                        <div class="col-span-12 sm:col-span-6">
                            <label for="modal-form-1" class="form-label">Tingkat</label>
                            <select data-placeholder="Pilih Kelas" name="tingkat" class="tom-select w-full" required>
            ...
            <div class="modal-content"> <a data-tw-dismiss="modal" href="javascript:;"> <i data-lucide="x" class="w-8 h-8 text-slate-400"></i> </a>
                <div class="modal-body p-0">
                    ...
                    <div class="px-5 pb-8 text-center">
                        <a type="button" href="<?= base_url('guru/data-kelas/delete/' . $item['id_kelas']) ?>" type="button" data-tw-dismiss="modal" class="btn btn-primary w-24">Hapus</a>
                    </div>
                </div>
            </div>
        </div>
