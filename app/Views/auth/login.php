    ...
    <div class="container sm:px-10">
        <div class="block xl:grid grid-cols-2 gap-4">
            <div class="hidden xl:flex flex-col min-h-screen">
                ...
                <div class="my-auto">
                    <img alt="Midone - HTML Admin Template" class="-intro-x w-1/2 -mt-16" src="<?= base_url() ?>source/dist/images/illustration.svg">
                    ...
                    <form action="<?= base_url('login') ?>" method="post">
                        <div class="intro-x mt-8 validate-form">
                            ...
                            <div class="input-form" for="validation-form-2">
                                <input id="validation-form-2" type="email" name="email" class="intro-x login__input form-control py-3 px-4 block" placeholder="Email" required>
                            </div>
