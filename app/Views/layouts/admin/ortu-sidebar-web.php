<nav class="side-nav">
    ...
    <ul>
        <li>
            <a href="<?= base_url('orangtua/dashboard') ?>" class="side-menu <?= ($active == 'dashboard') ? 'side-menu--active' : '' ?>">
        ...
        <li class="side-nav__devider my-6"></li>
        <li>
            <a href="<?= base_url('orangtua/prestasi-akademik') ?>" class="side-menu <?= ($active == 'prestasi') ? 'side-menu--active' : '' ?>">
                <div class="side-menu__icon"> <i data-lucide="book"></i> </div>
                <div class="side-menu__title"> Prestasi </div>
            </a>
        </li>
        <li>
            <a href="<?= base_url('orangtua/data-pelanggaran') ?>" class="side-menu <?= ($active == 'pelanggaran') ? 'side-menu--active' : '' ?>">
                <div class="side-menu__icon"> <i data-lucide="user-x"></i> </div>
                <div class="side-menu__title"> Pelanggaran Siswa </div>
            </a>
        </li>
        <li>
            <a href="<?= base_url('orangtua/rekap-monitoring') ?>" class="side-menu <?= ($active == 'rekap') ? 'side-menu--active' : '' ?>">
