...
<nav class="side-nav">
	...
	<ul>
		...
		<li>
			<a href="javascript:;" class="side-menu <?= ($active == 'siswa' || $active == 'guru' || $active == 'orangtua') ? 'side-menu--active' : '' ?>">
			...
			<ul class="<?= ($active == 'siswa' || $active == 'guru' || $active == 'orangtua') ? 'side-menu__sub-open' : '' ?>">
				<li>
				...
				<li>
					<a href="<?= base_url('admin/data-orangtua') ?>" class="side-menu <?= ($active == 'orangtua') ? 'side-menu--active' : '' ?>">
						<div class="side-menu__icon"> 
							<i data-lucide="git-commit"></i> 
						</div>
						<div class="side-menu__title"> Data Orangtua </div>
					</a>
				</li>
			</ul>
		</li>
